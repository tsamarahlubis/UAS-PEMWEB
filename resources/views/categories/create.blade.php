             ...
             <form action="{{ route('categories.store')}}" method="POST">
               @csrf
                ...
                <div class="form-group">
                   ...
                   <input id="input_category_slug" value="{{ old('slug')}}" name="slug" type="text" class="form-control
                ...
                <div class="form-group">
                   ...
                   <div class="input-group">
                      ...
                      <input id="input_category_thumbnail" name="thumbnail" value="{{ old('thumbnail')}}" type="text" class="form-control
                ...
                <div class="form-group">
                   ...
                   @if (old('parent_category'))
                       <option 
                       value="{{old('parent_category')->id}}" selected>{{old('parent_category')->title}}
                     </option>
                   @endif
                   </select>
                </div>
