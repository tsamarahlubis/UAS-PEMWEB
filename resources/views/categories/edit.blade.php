             ...
             <form action="{{ route('categories.update',['category' => $category])}}" method="POST">
               ...
               @csrf
                ...
                <div class="form-group">
                   ...
                   <input id="input_category_slug" value="{{ old('slug',$category->slug)}}" name="slug" type="text" class="form-control
                ...
                <div class="form-group">
                   ...
                   <div class="input-group">
                      ...
                      <input id="input_category_thumbnail" name="thumbnail" value=
                      "{{ old('thumbnail',asset($category->thumbnail))}}" type="text" class="form-control
                ...
                <div class="form-group">
                   ...
                   @if (old('parent_category',$category->parent))
                       <option 
                       value="{{old('parent_category',$category->parent)->id}}" 
                ...
                <div class="form-group">
                   ...
                   @error('description') is-invalid @enderror" rows="3" 
